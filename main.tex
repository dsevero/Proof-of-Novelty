...
Location-addressable systems reference resources based on its location. Examples are everyday systems such as bank accounts, housing addresses, traditional databases. Content-addressable systems use the content itself (usually in the form of a hash) as a locator.
